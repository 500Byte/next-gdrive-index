...
// Synchronously load site config
// Note: In Cloudflare Workers, this relies on the bundler inlining the JSON
// In Node.js, require() works synchronously
try {
  if (typeof require !== "undefined") {
    // Node.js / Build time - use require for synchronous loading
...
// Build config synchronously from multiple sources
...
// Keep initConfig for backwards compatibility (no-op now)
export async function initConfig() {
  // Config is now built synchronously, no initialization needed
}
